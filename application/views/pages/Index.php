                ...
                <div class="card border-0 shadow-sm"
                    ...
                    <div class="card-body d-flex flex-column justify-content-between align-items-center text-center p-3">
                        ...
                        <div class="dropdown mb-3">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="intervalDropdown-<?= $workspace->id ?>"
                        ...
                        <button class="btn btn-outline-danger btn-block toggle-workspace mt-auto"
                            data-workspace-id="<?= $workspace->id ?>" style="border-radius: 50px; border: 2px solid white; color: white;"
