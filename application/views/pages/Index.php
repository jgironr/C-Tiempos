        ...
        <div class="mb-4 d-flex justify-content-center mx-2">
            <div class="card border-0 shadow-sm"
                ...
                <div class="card-body d-flex flex-column justify-content-between align-items-center text-center p-3">
                    ...
                    <p class="card-text text-white text-center">Tarifa: Q<?= htmlspecialchars($workspace->rate) ?> por
                        hora</p>
                    ...
                    <div class="dropdown mb-3">
                        <button class="btn btn-secondary dropdown-toggle" type="button"
                            id="intervalDropdown-<?= $workspace->id ?>" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="intervalDropdown-<?= $workspace->id ?>">
                            ...
                            <a class="dropdown-item preset-interval" href="#"
